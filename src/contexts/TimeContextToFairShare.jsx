...
export const TimeContextToFairShare = createContext();

export function TimeContextToFairShareProvider({ children }) {
    let remindsTime;
    const [time, setTime] = useState(1000);
    const [isPrioritiesTrue, setisPrioritiesTrue] = useState(true);
    ...
    return (
        <TimeContextToFairShare.Provider
            value={{
